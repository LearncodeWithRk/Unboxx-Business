    ...
    <section className="relative w-full overflow-hidden bg-[#02040c] py-20 sm:py-28 lg:py-32">
      ...
      <div className="container relative z-10 mx-auto max-w-4xl px-4">
        <div className="flex flex-col items-center gap-y-6 text-center">
          ...
          >
            Unboxx Business connects to Google Business Profile, education review sites, and the systems your university already uses. No switching between platforms. No scattered logins.
          </p>

          <div
            className="flex flex-wrap items-center justify-center gap-4 md:justify-start animate-fade-in-up"
          ...
          >
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>Built to work with your existing systems</span>
            </div>
          </div>
        </div>
      </div>
